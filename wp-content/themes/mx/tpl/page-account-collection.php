...
<div class="panel">
	<div class="content">
		...
		<form action="javascript:;" id="fm-clt" class="form-horizontal">
			...
			<!-- post-content -->
			<div class="form-group">
				<label for="clt-content" class="g-tablet-1-6 control-label">
			...
			<!-- upload image -->
			<div class="form-group">
				<label for="clt-file" class="g-tablet-1-6 control-label">
			...
			<div class="form-group">
				...
				<div class="g-tablet-5-6">
					<div id="custom-tag">
						<div class="row">
							<?php for($i = 0;$i<=3;++$i){ ?>
								<div class="g-phonep-1-2 g-tablet-1-3 g-desktop-1-4">
