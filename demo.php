...
<title><?php echo $title;?>吾爱淘演示站点-wuaicc.taobao.com</title>
...
<body>
   <div id="header-bar">
     ...
     <p class="meta-data">
       <script type="text/javascript">document.write("<a target=\"_blank\" class=\"close\" href=\"<?php echo $xydown_yanshi;?>\">移除顶部</a>");</script> <a class="back" href="http://www.wuaicc.com" target="_blank" >宝贝吾爱淘旗舰店</a><a class="back" href="<?php echo dirname('http://'.$_SERVER['HTTP_HOST'].$_SERVER["REQUEST_URI"]); ?>/?p=<?php echo $id;?>" target="_blank" >返回介绍</a> 
<a class="back" target="_blank" href="<?php echo dirname('http://'.$_SERVER['HTTP_HOST'].$_SERVER["REQUEST_URI"]); ?>/?p=<?php echo $id;?>" >下载资源</a> <a class="back">温馨提示：本站所有始发资源站点都是调用其他网站界面而来，所以可能由于始发站更换内容/停止运营等原因造成于原有内容不一的情况！具体宝贝吾爱淘截图为准。</a>
